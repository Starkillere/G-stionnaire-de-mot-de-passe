...
"background-color: rgb(255, 255, 255);")
    ...
    def confirmer(self):
        ...
        if gestion_data.importation(fichier, user['master key'], user['id']):
            self.affichage.append("Successfull") 
        else:
...
"background-color: rgb(255, 255, 255);")
    ...
    def confirmer(self):
        ...
        if len(new_nom) > 0 and len(new_password) > 0:
            gestion_data.modifier(platforme, nom, user['id'], master_key=user['master key'], new_nom=new_nom, new_password=new_password) 
            self.affichage.append("Successfull")
        else:
