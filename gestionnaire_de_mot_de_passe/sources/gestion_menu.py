...
class Menu_4(QWidget):
    def __init__(self):
        ...
        self.is_senregistre = False
        self.is_rechercher = False
        self.is_importer = False
        self.is_supprimer = False
...
"font: 14pt \"Sitka Text\";")
        ...
        self.label_new_nom.move(600, 200)
        self.label_new_nom.setStyleSheet("color: rgb(255, 255, 255);\n"
"font: 14pt \"Sitka Text\";")

        self.label_new_password = QLabel("new mot de passe : ", self)
        self.label_new_password.move(600, 250)
        self.label_new_password.setStyleSheet("color: rgb(255, 255, 255);\n"
"font: 14pt \"Sitka Text\";")
...
"font: 14pt ;")
    ...
    def confirmer(self):
        ...
        if self.is_senregistre:
            ...
            del self.lineEdit_platforme
            del self.lineEdit_nom
            del self.label_password
            del self.lineEdit_mail

            del self.label_platforme
            del self.label_nom
            del self.lineEdit_password
            del self.lineEdit_mail

        elif self.is_rechercher:
            self.is_senregistre = False
            self.is_rechercher = False
            self.is_importer = False
            self.is_supprimer = False
            ...
            del self.lineEdit_fichier
            del self.label_fichier

        elif self.is_supprimer:
            self.is_senregistre = False
            self.is_rechercher = False
            self.is_importer = False
            self.is_supprimer = False
            ...
            if len(new_password) != 0:
                gestion_data.modifier(master_key=master_key, new_password=new_password) 
            if len(new_nom) != 0:
                gestion_data.modifier(master_key=master_key, new_nom=new_nom)
            self.affichage.append("Successfull")
            del self.lineEdit_new_nom
            del self.lineEdit_new_password
            del self.lineEdit_platforme
            del self.lineEdit_nom

            del self.label_platforme
            del self.label_nom
            del self.label_new_nom
            del self.label_new_password
